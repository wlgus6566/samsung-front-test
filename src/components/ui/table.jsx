...
function TableRow({ className, ...props }) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-muted/50 data-[state=selected]:bg-muted border-b transition-colors focus:bg-muted/70 focus:outline-2 focus:outline-primary/30 focus:outline-offset-[-2px]",
        className
      )}
      {...props}
    />
